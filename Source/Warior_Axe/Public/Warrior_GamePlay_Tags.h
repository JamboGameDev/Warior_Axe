...
namespace Warrior_GamePlay_Tags
{
	...
	WARIOR_AXE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_UnEquipAxe)

	/**Player tags**/
	WARIOR_AXE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Equip_Axe);
	WARIOR_AXE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_UnEquip_Axe);
